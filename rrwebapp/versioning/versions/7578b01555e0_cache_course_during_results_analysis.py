...
def upgrade():
    ...
    op.add_column(u'raceresult', sa.Column('sourceresultid', sa.String(length=128), nullable=True))
    op.add_column(u'raceresultservice', sa.Column('attrs', sa.String(length=200), nullable=True))
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_column(u'raceresultservice', 'attrs')
    op.drop_column(u'raceresult', 'sourceresultid')
