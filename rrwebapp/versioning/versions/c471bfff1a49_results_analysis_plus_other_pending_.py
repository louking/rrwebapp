...
def upgrade():
    ...
    op.add_column(u'club', sa.Column('memberserviceapi', sa.String(length=20), nullable=True))
    op.add_column(u'club', sa.Column('memberserviceid', sa.String(length=64), nullable=True))
    op.create_foreign_key(None, 'divisions', 'club', ['club_id'], ['id'])
    op.add_column(u'race', sa.Column('external', sa.Boolean(), nullable=True))
    op.add_column(u'race', sa.Column('location', sa.String(length=64), nullable=True))
    op.create_foreign_key(None, 'race', 'club', ['club_id'], ['id'])
    op.add_column(u'raceresult', sa.Column('divisionpoints', sa.Float(), nullable=True))
    op.add_column(u'raceresult', sa.Column('fuzzyage', sa.Boolean(), nullable=True))
    op.add_column(u'raceresult', sa.Column('genderpoints', sa.Float(), nullable=True))
    op.add_column(u'raceresult', sa.Column('overallpoints', sa.Float(), nullable=True))
    op.add_column(u'raceresult', sa.Column('source', sa.String(length=20), nullable=True))
    op.add_column(u'raceresult', sa.Column('sourceid', sa.String(length=128), nullable=True))
    op.create_foreign_key(None, 'raceresult', 'club', ['club_id'], ['id'])
    op.create_foreign_key(None, 'runner', 'club', ['club_id'], ['id'])
    op.add_column(u'series', sa.Column('allowties', sa.Boolean(), nullable=True))
    op.add_column(u'series', sa.Column('description', sa.String(length=20), nullable=True))
...
def downgrade():
    ...
    op.drop_column(u'series', 'description')
    op.drop_column(u'series', 'allowties')
    op.drop_constraint(None, 'runner', type_='foreignkey')
    op.drop_constraint(None, 'raceresult', type_='foreignkey')
    op.drop_column(u'raceresult', 'sourceid')
    op.drop_column(u'raceresult', 'source')
    op.drop_column(u'raceresult', 'overallpoints')
    op.drop_column(u'raceresult', 'genderpoints')
    op.drop_column(u'raceresult', 'fuzzyage')
    op.drop_column(u'raceresult', 'divisionpoints')
    op.drop_constraint(None, 'race', type_='foreignkey')
    op.drop_column(u'race', 'location')
    op.drop_column(u'race', 'external')
    op.drop_constraint(None, 'divisions', type_='foreignkey')
    op.drop_column(u'club', 'memberserviceid')
    op.drop_column(u'club', 'memberserviceapi')
